  ...
  (function () {
      ...
      var ha = /^(\/[a-zA-Z0-9_\-]+)+$/,
          ...
          qa = function (a, b, c, d) {
              ...
              return [f(a.d)[n](/%2C/g, ",")[n](/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.a ? "/am=" + e(a.a) : "", a.b ? "/rs=" + e(a.b) : "", "/cb=", e(c)][B]("")
          },
          pa = function (a) {
              "/" !== a.charAt(0) && T("relative path");
              for (var b = a.substring(1)[s]("/"), c = []; b[A];) {
                  a = b[m]();
                  if (!a[A] || 0 == a.indexOf(".")) T("empty/relative directory");
                  else if (0 < a.indexOf("=")) {
                      b.unshift(a);
                      break
                  }
  ...
  gapi.load("client", {
      ...
      _c: {
          "jsl": {
              ...
              "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.Y7yo-hE6f2w.O/m\u003d__features__/am\u003dEQ/rt\u003dj/d\u003d1/t\u003dzcms/rs\u003dAItRSTN93bpEwaWpObiMvM25GxQjfuQ5ZQ",
              "u": "https://apis.google.com/js/client.js",
              "hee": true,
              "fp": "7a1717066297ae0db3669ceaa7b35514f7977d17",
              "dpo": false
          },
          "fp": "7a1717066297ae0db3669ceaa7b35514f7977d17",
